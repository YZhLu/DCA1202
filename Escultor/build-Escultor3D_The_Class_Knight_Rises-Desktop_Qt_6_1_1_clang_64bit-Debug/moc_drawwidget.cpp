...
#include <memory>
#include "../Escultor3D_The_Class_Knight_Rises/drawwidget.h"
...
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 7) // "setfreq"

    },
    "DrawWidget\0updatePos\0\0setfreq"
};
...
void DrawWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updatePos((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->setfreq((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DrawWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawWidget::updatePos)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DrawWidget::updatePos(int _t1, int _t2)
{
